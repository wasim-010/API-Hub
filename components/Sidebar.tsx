...
const Sidebar: React.FC<SidebarProps> = ({ onSearchClick, activeSection, selectedCategory, onSelectCategory }) => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[280px] bg-bg border-r border-border flex flex-col z-40">
      {/* Header */}
      <div className="h-[56px] flex items-center px-6 border-b border-border bg-surface/50 backdrop-blur">
        <div 
